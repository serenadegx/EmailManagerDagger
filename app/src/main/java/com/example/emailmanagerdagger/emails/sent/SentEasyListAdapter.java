...
public class SentEasyListAdapter extends EasyListAdapter<Email> {
    public SentEasyListAdapter(List<Email> data, RecyclerView recyclerView, LoadMoreListener loadMoreListener) {
