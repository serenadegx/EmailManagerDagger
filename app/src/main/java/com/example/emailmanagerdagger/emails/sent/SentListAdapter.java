...
public class SentListAdapter extends RecyclerView.Adapter<SentListAdapter.WrapperViewHolder> {

    private final ItemListener mItemListener;
    private List<Email> mData;

    public SentListAdapter(ItemListener mItemListener, List<Email> mData) {
    ...
    public WrapperViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new WrapperViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sent, parent, false));
    }
